            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">View Medicine Category</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>View Medicine Category</h5>
                                <a href="{{url('/admin/add_category')}}" class="btn btn-info page-header-breadcrumb"><i class="ti-plus"></i> Add Category</a>
                            </div>
