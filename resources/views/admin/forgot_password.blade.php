            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body">
                        <form id="loginForm" class="md-float-material" method="post" action="{{route('forgot-password')}}">
                            @csrf
                            ...
                            <div class="auth-box">
                                ...
                                <div class="input-group">
                                    <input type="email" name="email" class="form-control" placeholder="Your Email Address" required autofocus autocomplete="off">
