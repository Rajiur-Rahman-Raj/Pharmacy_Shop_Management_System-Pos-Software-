                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="pos_invoice_field m-t-25">
                                                            ...
                                                            <hr>
                                                            <div class="form-group row">
                                                                <label class="col-sm-6 f-16">Paid Amount</label>
                                                                <div class="col-sm-6">
                                                                    <input type="text" class="form-control net_amount_dipu" name="net-amount" id="grand_total" value="{{ $item_total }}" readonly>
                                                                </div>
                                                            </div>
                                                            <div id="paidAmount">
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response != undefined){
                        ...
                        // paidOutput += '<label class="col-sm-6 f-16">Paid Amount kk</label>';
                        ...
                        var net_amount_dipu = $('.net_amount_dipu').val();
