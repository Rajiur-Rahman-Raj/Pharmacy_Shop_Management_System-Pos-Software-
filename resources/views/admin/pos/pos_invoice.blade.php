                                        ...
                                        <div id="printDiv">
                                            <table border="0" class="table-responsive">
                                                <tbody>
                                                        ...
                                                        <td>
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="center">
                                                                            <nobr>
                                                                                <date style="border-bottom: 2px solid #a0a0a0;">Date:{{ date('d M Y', strtotime($invoice_data[0]->created_at))}}<time></time></date>
                                                                            </nobr>
                                                                        </td>
                                                                        @endif
                                                                    </tr>
                                                            ...
                                                            <table width="100%" style="margin-top: 20px !important;">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td align="left"><nobr></nobr></td>
                                                                        <td align="left" colspan="3"><nobr><strong>Paid Amount</strong></nobr></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            Powered By: Web Training Institute
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
