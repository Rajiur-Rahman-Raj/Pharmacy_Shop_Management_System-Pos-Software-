            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">View Expense</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>View Expense</h5>
                                <a href="{{url('/admin/add_expense')}}" class="btn btn-info page-header-breadcrumb"><i class="ti-plus"></i> Add Expense</a>
                            </div>
                            <div class="card-block">
		                        ...
		                        <div class="dt-responsive table-responsive">
		                            <table id="expenseTable" class="table table-striped table-bordered nowrap">
		                                <thead>
		                                    <tr>
		                                        <th>#</th>
		                                        <th>Entry Date</th>
    ...
    <script>
        $(document).ready(function(){
            $('#expenseTable').DataTable({
                "processing":true,
                "serverSide":true,
                "ajax": "{{route('ajax.get_expenses_data')}}",
                "columns":[
                    {"data" : "id"},
                    {"data" : "entry_date"},
